            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-leaf bg-green"></i> Detail</h2>
                    </div><!-- end col -->
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <div class="single-post-media">
                                <img src="{{ asset('storage/images/bai-viet/' . $blog->image) }}" alt=""
                                    class="img-fluid">
                            </div><!-- end media -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="blog-box">
                                            ...
                                            <div class="blog-meta">
                                                <h4><a href="garden-single.html" title="">We are guests of ABC Design
                                                        Studio</a></h4>
